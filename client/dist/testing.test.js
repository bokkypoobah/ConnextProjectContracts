...
describe('makeSuccinctChannel', () => {
    it('should work', () => {
        testing_1.assert.deepEqual(t.makeSuccinctChannel({
            balanceWeiHub: '1',
            balanceWeiUser: '2',
            timeout: 69,
        }), {
...
describe('makeSuccinctThread', () => {
    it('should work', () => {
        testing_1.assert.deepEqual(t.makeSuccinctThread({
            balanceWeiSender: '1',
...
describe('expandSuccinctChannel', () => {
    it('should work', () => {
        testing_1.assert.deepEqual(t.expandSuccinctChannel({
            balanceWei: ['1', '2'],
            timeout: 69,
        }), {
            balanceWeiHub: '1',
...
describe('expandSuccinctThread', () => {
    it('should work', () => {
        testing_1.assert.deepEqual(t.expandSuccinctThread({
            balanceWei: ['1', '2'],
        }), {
            balanceWeiSender: '1',
            balanceWeiReceiver: '2',
