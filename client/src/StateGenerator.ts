...
export class StateGenerator {
  ...
  public proposePendingWithdrawal(prev: ChannelStateBN, args: WithdrawalArgsBN): UnsignedChannelState {
    ...
    const offChainBalWei = minBN(args.weiToSell, n.pendingDepositWeiHub)
    ...
    const offChainBalToken = minBN(args.tokensToSell, n.pendingDepositTokenHub)
